...
TUTORIALS_DIR=docs_archive/source/tutorials

# For each *qmd file in docs_archive/source/tutorials, create a
# corresponding md file under docs_archive/source/tutorials
COUNTER=0

# Removing everything under docs_archive/source/tutorials/*.md with
