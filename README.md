...
We use `RandomVariable`s to build probabilistic models.
We represent complete models as concrete subclasses of the `Model` abstract base class.
...
- [CDCgov/pyrenew-covid-wastewater](https://github.com/CDCgov/pyrenew-covid-wastewater): *Models and infrastructure for forecasting COVID-19 hospitalizations using wastewater data with PyRenew.*
- [CDCgov/pyrenew-flu-light](https://github.com/CDCgov/pyrenew-flu-light/): *An instantiation in PyRenew of an influenza forecasting model used in the 2023-24 respiratory season.*
...
This repository was created for use by CDC programs to collaborate on public health related projects in support of the [CDC mission](https://www.cdc.gov/about/cdc/index.html#cdc_about_cio_mission-our-mission).
