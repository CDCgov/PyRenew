Functions, classes, and packages designs should be straightforward.
The code needs to be clean and human-readable and human-maintainable.
Factor repeated computation into general functions.
Avoid overly general and extensible frameworks.
...
I will commit and push edited files to GitHub myself - do not commit or push unless I tell you to.
