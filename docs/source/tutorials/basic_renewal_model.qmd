...
mean_Rt = y_data.mean(dim=["chain", "draw"])
axes.plot(x_data, mean_Rt, color="C0", label="Mean")
axes.legend()
...
# Add mean of the posterior to the figure
mean_latent_infections = y_data.mean(dim=["chain", "draw"])

axes.plot(x_data, mean_latent_infections, color="C0", label="Mean")
axes.legend()
