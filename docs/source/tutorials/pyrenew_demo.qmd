...
plt.plot(np.exp(q_samp[0].array))
```
...
ax[0].plot(x.latent_infections.array)
ax[0].set_ylim([1 / 5, 5])
ax[1].plot(x.latent_hosp_admissions.array)
ax[2].plot(x.observed_hosp_admissions.array, "o")
for axis in ax[:-1]:
    axis.set_yscale("log")
```
...
hospmodel.run(
    num_warmup=1000,
    num_samples=1000,
    data_observed_hosp_admissions=x.observed_hosp_admissions.array,
