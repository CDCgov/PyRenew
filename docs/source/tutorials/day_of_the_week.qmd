...
hosp_rate = metaclass.DistributionalVariable(
...
I0 = InfectionInitializationProcess(
    "I0_initialization",
    metaclass.DistributionalVariable(
        name="I0",
...
class MyRt(metaclass.RandomVariable):
    ...
    def sample(self, n: int, **kwargs) -> tuple:
        ...
        # Random walk step
        step_rv = metaclass.DistributionalVariable(
            name="rw_step_rv", distribution=dist.Normal(0, sd_rt.value)
        )

        rt_init_rv = metaclass.DistributionalVariable(
        ...
        rt_rv = metaclass.TransformedVariable(
            name="Rt_rv",
            base_rv=base_rv,
...
nb_conc_rv = metaclass.TransformedVariable(
    "concentration",
    metaclass.DistributionalVariable(
...
dayofweek_effect = metaclass.TransformedVariable(
    name="dayofweek_effect",
    base_rv=metaclass.DistributionalVariable(
