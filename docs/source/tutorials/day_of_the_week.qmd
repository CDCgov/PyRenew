...
# retrieve the prior predictive samples from hosp_model_dow
ppc_samples_dow = hosp_model_dow.posterior_predictive(
    n_datapoints=daily_hosp_admits.size,
    numpyro_predictive_args={"num_samples": 500},
)
# create an InferenceData object from hosp_model_dow
dow_idata = az.from_numpyro(
    posterior=hosp_model_dow.mcmc,
    posterior_predictive=ppc_samples_dow,
)
print(dow_idata.posterior_predictive)
# use a time series plot (plot_ts) from arviz for plotting
# axes = az.plot_ts(
#     dow_idata.prior["dayofweek_effect_raw"],
#     y=dow_idata.prior["dayofweek_effect_raw"],
#     num_samples=500,
#     backend_kwargs={"figsize": (8, 6)},
#     textsize=15.0,
# )
...
# ax = axes[0][0]
# ax.set_ylabel("Day Of the Week Effect", fontsize=20)
# plt.show()
```
