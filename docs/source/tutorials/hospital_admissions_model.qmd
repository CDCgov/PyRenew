...
Were $d(\tau)$ is the infection to hospitalization interval, $I(t)$ is the number of latent infections at time $t$, $p_\mathrm{hosp}(t)$ is the infection to hospitalization rate.
...
nb_conc_rv = metaclass.DistributionalRV(
    dist.LogNormal(
        loc=jnp.log(1),
        scale=jnp.log(10),
    ),
...
# Admissions plot
axs[1].plot(simulated_data.observed_hosp_admissions)
