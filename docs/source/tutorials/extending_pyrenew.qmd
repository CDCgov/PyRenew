...
feedback_strength = DeterministicVariable(0.01, name="feedback_strength")
...
I0 = InfectionInitializationProcess(
    ...
    InitializeInfectionsExponentialGrowth(
        gen_int_array.size,
        DeterministicVariable(0.05, name="rate"),
    ),
    t_unit=1,
)
...
fig, ax = plt.subplots()
ax.plot(model0_samp.latent_infections.array)
ax.set_xlabel("Time")
    ...
    def sample(
        ...
        **kwargs,
        ...
        inf_feedback_strength = au.pad_x_to_match_y(
            x=inf_feedback_strength.array,
            y=Rt,
            fill_value=inf_feedback_strength.array[0]
        )
        ...
        return InfFeedbackSample(
            infections=TimeArray(all_infections),
            rt=TimeArray(Rt_adj),
        )
```
...
ax[0].plot(model0_samp.latent_infections.array)
ax[1].plot(model1_samp.latent_infections.array)
