...
This document illustrates how a hospital admissions-only model can be fitted using simulated example data.
...
The generation interval and the infection to hospital admission interval are `RandomVariable`s.
