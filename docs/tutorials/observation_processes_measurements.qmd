...
# Use same y-axis range as sampled-concentrations plot for comparison
y_min = ww_samples_df["log_concentration"].min()
y_max = ww_samples_df["log_concentration"].max()
