...
dow_df["day"] = pd.Categorical(dow_df["day"], categories=day_names, ordered=True)
...
We construct two `PopulationCounts` observation processes using the same delay distribution and ascertainment rate.
...
(
    ...
    + p9.geom_line(p9.aes(group="sample"), alpha=0.15, size=0.4, color="steelblue")
    + p9.geom_line(
        data=mean_df,
