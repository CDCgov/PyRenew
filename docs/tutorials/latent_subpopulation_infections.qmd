...
#| fig-cap: >-
#|   AR(1) deviation trajectories (50 samples, all 6 subpopulations).
#|   Because `AR1` draws its initial value from the stationary distribution, the envelope is already at its stationary width at day 0 and stays bounded there.
#|   Compare the y-axis scale to fig-rw-deviations below.
...
#| fig-cap: >-
#|   RandomWalk deviation trajectories (50 samples, 6 subpopulations).
#|   The envelope fans out continuously over the 28-day horizon and reaches roughly three times the AR(1) stationary width.
#|   The y-axis matches fig-ar1-deviations above for direct comparison.
