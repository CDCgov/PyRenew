...
-   **[Hierarchical Latent Infections](latent_hierarchical_infections.md)**: Understanding temporal process choices for $R(t)$
...
-   **Jurisdiction-level** (`baseline_rt_process`): AR(1) process for the baseline $R(t)$
...
-   Explore different temporal processes for $R(t)$ in the [Hierarchical Latent Infections](latent_hierarchical_infections.md) tutorial
