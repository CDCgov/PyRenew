...
idata_90 = az.from_numpyro(
    ...
    dims={
        ...
        "latent_infections/log_rt_baseline": ["time", "dummy"],
        "latent_infections/rt_baseline": ["time", "dummy"],
        "latent_infections/rt_subpop": ["time", "subpop"],
        "latent_infections/subpop_deviations": ["time", "subpop"],
...
idata_90_trimmed = idata_90.isel(time=slice(n_init, None), groups="posterior")
idata_90_trimmed.posterior = idata_90_trimmed.posterior.assign_coords(
    time=np.arange(n_days_90)
)
az.summary(
...
idata_180_trimmed = idata_180.isel(
    time=slice(n_init, None), groups="posterior"
)
idata_180_trimmed.posterior = idata_180_trimmed.posterior.assign_coords(
    time=np.arange(n_days_180)
)
az.summary(
...
ci_width_180 = quantiles_90["q95"] - quantiles_90["q05"]
