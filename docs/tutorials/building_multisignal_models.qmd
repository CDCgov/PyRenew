...
def prepare_observation_data(model, n_days_fit, hosp_admits, ww_data, K_obs):
    """
...
obs_data_90 = prepare_observation_data(
    model, n_days_90, hosp_admits, ca_ww_data, K_obs
)
...
obs_data_180 = prepare_observation_data(
    model, n_days_180, hosp_admits, ca_ww_data, K_obs
)
