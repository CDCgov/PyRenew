...
`HierarchicalInfections` addresses this by decomposing the effective reproduction number $\mathcal{R}(t)$ into:
...
- [Building Multi-Signal Renewal Models](building_multisignal_models.md)
