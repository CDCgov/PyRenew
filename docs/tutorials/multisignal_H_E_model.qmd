...
Because this is a synthetic recovery example, we center the initial infection and ascertainment
priors at the data-generating values and make them intentionally informative.
A later sensitivity analysis relaxes these priors to show how the latent infection scale depends
on external information about initial prevalence and ascertainment.
...
The posterior latent infection interval should also cover most of the true synthetic infection trajectory.
...
Finally, we visualize posterior latent infections alongside the observed hospital and ED signals.
