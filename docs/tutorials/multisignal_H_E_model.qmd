...
#| fig-cap: Relative posterior interval width for latent infections over the
#|   synthetic H+E fit.
...
#| fig-cap: Posterior uncertainty intervals over infections under the two
...
#| fig-cap: Posterior densities for $I_0$, IHR, and IEDR under all three models.
