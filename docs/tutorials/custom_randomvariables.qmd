...
This tutorial illustrates how define new `RandomVariable` classes in order to extend existing models and build new ones,
according to [PyRenew principles](../developer_documentation.md){pyrenew-principles}.
