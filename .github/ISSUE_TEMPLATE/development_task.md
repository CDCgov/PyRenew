...
about: A template for writing specs following Multisignal Renewal project
  standards
title: ""
...
This template should be used as an outline.
It may not be necessary to fill out every section.
Delete this block of text and fill in anything in brackets.
...
\[1-3 sentence summary of the issue or feature request.
E.g. "We want to be able to ..."\]
...
\[A checklist to keep track of details for each feature.
At least one specification per feature is recommended.
