...
idata_weekday = az.from_numpyro(hosp_model_weekday.mcmc,
posterior_predictive=hosp_model_weekday.posterior_predictive(n_timepoints_to_simulate=len(dat_w_padding)))
```
...
plt.plot(idata_weekday.posterior_predictive["negbinom_rv_dim_0"], mean_latent_infection[0], color="C0", label="Mean")
plt.scatter(
