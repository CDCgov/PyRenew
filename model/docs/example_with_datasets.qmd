...
az.plot_ppc(
    idata,
    kind="scatter",
    coords={"negbinom_rv_dim_0": [10, 11]},
    flatten=[],
    ax=ax,
)

fig.suptitle("Posterior Predictive Check Plots")
ax[0].set_xlabel("Hospital Admissions[30]")
ax[1].set_xlabel("Hospital Admissions[31]")
plt.show()
```
...
We can also look at credible intervals for the posterior distribution latent infections:
