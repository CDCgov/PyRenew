...
from pyrenew.metaclass import DistributionalRVSample
```
...
I0 = DistributionalRVSample(dist=dist.LogNormal(0, 1), name="I0")
    ...
    def sample(
        ...
        **kwargs,
        ...
        all_infections, Rt_adj = compute_infections_from_rt_with_feedback(
            ...
            reversed_infection_feedback_pmf=inf_feedback_pmf,
        )
