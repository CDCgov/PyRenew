...
(1) generation interval, the times between infections. In this example, the generation interval is not estimated but passed as a deterministic instance of `RandomVariable`
