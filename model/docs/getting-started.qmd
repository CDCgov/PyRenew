...
from pyrenew.latent.infection_seeding_method import SeedInfectionsZeroHstack
```
...
I0 = InfectionSeedingProcess(dist.LogNormal(0, 1), SeedInfectionsZeroHstack(pmf_array.size))
