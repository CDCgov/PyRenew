...
We can use [ArviZ](https://www.arviz.org/) package to create model diagnostics and visualizations. Below we use `plot_trace` to inspect the trace of daily $R_t$ estimates.
