"""
Test the InfectionSRTFeedback class
"""
...
def test_infectionsrtfeedback():
    ...
    inf_feed_strength = DeterministicVariable(jnp.array([0]))
    inf_feedback_pmf = DeterministicPMF(gen_int)

    # Test the InfectionsRTFeedback class
    infectionsrtfeedback = latent.InfectionsRtFeedback(
    ...
    with npro.handlers.seed(rng_seed=0):
        samp1 = infectionsrtfeedback.sample(
            gen_int=gen_int,
            Rt=Rt,
            I0=I0,
        )
